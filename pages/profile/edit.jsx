...
const Edit_user = () => {
  ...
  const setImageFormData = useCallback(
    (name, value) => {
      const newFormData = { ...formData };
      newFormData[name] = value;
      setFormData(newFormData);
  ...
  useEffect(() => {
    if (profilePhoto) {
      ...
      reader.onloadend = () => {
        setImageFormData("profileImage", reader.result);
  ...
  }, [profilePhoto, setImageFormData]);

  useEffect(() => {
    if (coverPhoto) {
      const reader = new FileReader();
      reader.onloadend = () => {
        setImageFormData("bannerImage", reader.result);
    ...
    <div>
      ...
      <div className="pt-[5.5rem] lg:pt-24">
        ...
        <div className="relative">
          <img
            src={coverPreview ? coverPreview : formData.bannerImage || "/images/user/banner.jpg"}
            alt="banner"
                ...
                {/* <div className="mb-6">
									...
									<div className="relative">
										<svg
											...
											data-prefix="fab"
											data-icon="twitter"
											className="absolute w-4 h-4 -translate-y-1/2 pointer-events-none fill-jacarta-300 dark:fill-jacarta-400 top-1/2 left-4"
											role="img"
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 512 512"
										>
										...
										<input
											type="text"
											id="profile-twitter"
											className="w-full py-3 pl-10 rounded-t-lg dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 focus:ring-inset dark:text-white"
									...
									<div className="relative">
										...
										<input
											...
											className="w-full py-3 pl-10 -mt-px dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 focus:ring-inset dark:text-white"
									...
									<div className="relative">
										...
										<input
											type="url"
											id="profile-website"
											className="w-full py-3 pl-10 -mt-px rounded-b-lg dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 focus:ring-inset dark:text-white"
              ...
              <div className="flex space-x-5 md:w-1/2 md:pl-8">
                <form className="shrink-0">
                  <figure className="relative inline-block">
                    <Image
                      src={preview ? preview : formData.profileImage || "/images/user/user_avatar.gif"}
